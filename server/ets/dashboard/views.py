...
def view_dashboard(request,user_id):
     ...
     return render(request,'dashboard/dashboard_home.html',{'nbar': 'home','role':user.role,'user_id':user_id,'data':data,'user':user})

def get_team_data():
     teams_data=[
        {"member_name":"saket","team_name":"xyz","department":"Software Engineering","prod_per":65,"unprod_per":25,"break_per":10},
        {"member_name":"isha","team_name":"xyz","department":"Software Engineering","prod_per":75,"unprod_per":10,"break_per":15},
        {"member_name":"mahi","team_name":"abcd","department":"Sales","prod_per":70,"unprod_per":25,"break_per":5},
        {"member_name":"manan-employee","team_name":"abcd","department":"Sales","prod_per":69,"unprod_per":22,"break_per":9},
        ]
