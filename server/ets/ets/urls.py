...
from ets.apis.views.data_collection_view import CollectData, ToggleBreak, ToggleProdCategory
...
urlpatterns = [
    ...
    path('toggle-prod-category', ToggleProdCategory.as_view(), name="toggle-prod-category"),
